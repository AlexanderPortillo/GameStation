...
| `circle-t-l-1 y -100` | border-top-left-radius     | px               |                                   |
| `circle-t-r-1 y -100` | border-top-right-radius    | px               |                                   |
| `circle-b-l-1 y -100` | border-bottom-left-radius  | px               |                                   |
| `circle-b-r-1 y -100` | border-bottom-right-radius | px               |                                   |
